...
%>
<%List<Card> list=obj.getCard(u.getId());%>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item "><a class="menu__link" href="index1.jsp">Home <span class="sr-only">(current)</span></a></li>
	...
	<div class="container">
				...
				if(al.contains(p.getId())){
					...
					<tr class="rem1">
						<td class="invert-closeb">
							<div class="rem">
							<a href="UserController?action=del&id=<%=itr.next().getId()%>">	<div class="close1"> </div>
							</div>
						...
						<td class="invert-image"><a href="single.html"><img src="data:image/jpg;base64,<%=s1%>" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity"> 
						...
						<td class="invert">$<%=p.getSprice() %></td>
					</tr><%itr.hasNext();}} %>
		...
		<div class="checkout-left">	
				...
				<div class="checkout-right-basket animated wow slideInRight" data-wow-delay=".5s">
					<a href="index1.jsp"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Back To Shopping</a>
				</div>
				...
				if(al.contains(p.getId())){
							%>
						<li><%=p.getPname() %> <i>-</i> <span>$<%=p.getSprice() %></span></li>
						<% total=total+p.getSprice(); %>
												<%}} %>
