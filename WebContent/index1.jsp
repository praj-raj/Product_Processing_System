...
<%@page import="com.rdec.models.Card"%>
...
<%@page import="com.rdec.services.UserServiceImpl"%>
<%@page import="com.rdec.services.UserService"%>
...
<body>
<!-- header -->
<%List<Card> list1=(List<Card>)session.getAttribute("a"); %>
<%System.out.print(list1); %>
<%//session.setAttribute("a",list1); %>
...
<div class="header">
	<div class="container">
		<ul>
			...
			<li><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>${use} </li>
			<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span><a href="mailto:info@example.com">praveshsharmasihani@gmail.com</a></li>
		</ul>
	</div>
</div>
<!-- //header -->
...
<div class="header-bot">
	<div class="container">
		<div class="col-md-3 header-left">
			<h1><a href="index1.jsp"><img src="images/logo3.jpg"></a></h1>
		</div>
		<div class="col-md-6 header-middle">
			<form action="UserController" method="post">
				<input type="hidden" name="action" value="Search">
				<div class="search">
					<input type="search" value="Search" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search';}" required="" name="ser">
				</div>
				<%List<String> s=new ArrayList<String>();%>
 	<%for(Product p:b){
				if(!s.contains(p.getPcatagery())){
							s.add(p.getPcatagery());
							}}%>
				<div class="section_room">
					<select id="country" onchange="change_country(this.value)" class="frm-field required" name="country" >
						...
						<%for(String list:s){ %>						
					<option value="<%=list %>" ><a href="Product1.jsp?action=<%=list%>"><%=list%></a></option> 
						<%} %> 
					</select>
				</div>
				<div class="sear-sub">
		...
		<div class="col-md-3 header-right footer-bottom">
			<ul>
				<li><a href="UserController?action=logout" class="use1" ><span>Logout</span></a>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav menu__list">
					<li class="active menu__item menu__item--current"><a class="menu__link" href="index1.jsp">Home <span class="sr-only">(current)</span></a></li>
								...
								<div class="row">
									...
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="UserController?action=Catagery&Catagery=Men">Clothing</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Wallets</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Footwear</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Watches</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Accessorirs</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Bags</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Caps & Hats</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="UserController?action=Catagery&Catagery=Men">Jewellery</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Sunglasses</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Perfumes</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Beauty</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Shirts</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Sunglasses</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Men">Swimwear</a></li>
										</ul>
									</div>
									<div class="clearfix"></div>
								</div>
						...
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">women's wear <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="UserController?action=Catagery&Catagery=Women">Clothing</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Wallets</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Footwear</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Watches</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Accessories</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Bags</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Caps & Hats</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="UserController?action=Catagery&Catagery=Women">Jewellery</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Sunglasses</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Perfumes</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Beauty</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Shirts</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Sunglasses</a></li>
											<li><a href="UserController?action=Catagery&Catagery=Women">Swimwear</a></li>
										</ul>
									</div>
					...
					<li class=" menu__item"><a class="menu__link" href="UserController?action=Catagery&Catagery=Electronics">Electronics</a></li>
			...
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				...
				<div class="resp-tabs-container">
					<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
						...
						<% for(Product p:b){
							String s1=Base64.getEncoder().encodeToString(p.getIm());
							%>
							<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="data:image/jpg;base64,<%=s1%>" alt="" class="pro-image-front">
									<img src="data:image/jpg;base64,<%=s1%>" alt="" class="pro-image-back">
								...
								<div class="item-info-product ">
									<h4><a href="single.html"><%=p.getPname() %></a></h4>
									<div class="info-product-price">
										<span class="item_price">$<%=p.getSprice() %></span>
										<del>$<%=p.getPrice() %></del>
									</div>
									<%User u=(User)session.getAttribute("user"); %>
									<a href="UserController?action=cart&Pid=<%=p.getId()%>&Uid=<%=u.getId()%>" class="item_add single-item hvr-outline-out button2">Add to cart</a>									
								</div>
							</div>
						</div>
						<%} %>
