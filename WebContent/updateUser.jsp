...
<!DOCTYPE html>
	...
	<body>
    	...
    	<form class="registration" action="UserController" method="post">>
            ...
            <label>E-Mail</label>
            <input type="text" maxlength="120" value="${user.email}"placeholder="Email" name="email"/>
            <label>Password</label>
            <input type="text" maxlength="20" value="${user.pass}" placeholder="Password" name="password"/>   
            <label>User Type</label>
            <input type="text"  placeholder="Confirm" value="${user.userType}" maxlength="20" name="type"/>                                                                                 
        </fieldset>
        <fieldset>   
