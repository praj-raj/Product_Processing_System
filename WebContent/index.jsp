	...
	<div class="container">
		...
		<div class="col-md-6 header-middle" >
			<form action="#"  method="post">
				...
				<div class="search" class="use1" data-toggle="modal" data-target="#myModal4">
 	...
 	<%for(Product p:b){
				...
				<div class="section_room">
					<select id="country" onchange="change_country(this.value)" class="frm-field required" name="country" class="use1" data-toggle="modal" data-target="#myModal4">
								...
								<div class="row" >
									...
									<div class="col-sm-3 multi-gd-img" >
										<ul class="multi-column-dropdown" >
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Clothing</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Wallets</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Footwear</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Watches</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Accessorirs</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Bags</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Caps & Hats</a></li>
										</ul>
									</div>
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Jewellery</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Sunglasses</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Perfumes</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Beauty</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Shirts</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Sunglasses</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Swimwear</a></li>
										</ul>
									</div>
									<div class="clearfix"></div>
								</div>
						...
						<a href="#" class="dropdown-toggle menu__link" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">women's wear <span class="caret"></span></a>
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									<div class="col-sm-3 multi-gd-img">
										<ul class="multi-column-dropdown">
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Clothing123</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Wallets</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Footwear</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Watches</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Accessories</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Bags</a></li>
											<li><a href="#" class="use1" data-toggle="modal" data-target="#myModal4">Caps & Hats</a></li>
										</ul>
									</div>
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="#" class="use1" data-toggle="modal" data-target="#myModal4"><img src="images/woo.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
					</li>
					<li class=" menu__item"><a class="menu__link" href="#" class="use1" data-toggle="modal" data-target="#myModal4">Electronics</a></li>
					<li class=" menu__item"><a class="menu__link" href="#" class="use1" data-toggle="modal" data-target="#myModal4">Short Codes</a></li>
					<li class=" menu__item"><a class="menu__link" href="#" class="use1" data-toggle="modal" data-target="#myModal4">contact</a></li>
				  </ul>
				</div>
			  </div>
			</nav>	
		...
		<div class="new_grids">
			<div class="col-md-4 new-gd-left">
				...
				<div class="wed-brand simpleCart_shelfItem">
					...
					<p><i>$250</i> <span class="item_price">$500</span><a class="item_add hvr-outline-out button2" href="#" class="use1" data-toggle="modal" data-target="#myModal4">add to cart </a></p>
				</div>
			</div>
			<div class="col-md-4 new-gd-middle">
				<div class="new-levis">
					...
					<div class="mid-text">
						...
						<a class="hvr-outline-out button2" href="product.html" class="use1" data-toggle="modal" data-target="#myModal4">Shop now </a>
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="new-levis">
				...
				<div class="img-box"><img src="images/p1.jpg" alt="image" class="img-responsive zoom-img"></div>
					<div class="info-box">
						<div class="info-content simpleCart_shelfItem">
									...
									<span class="separator"></span>
									<a class="item_add hvr-outline-out button2" href="#" class="use1" data-toggle="modal" data-target="#myModal4">add to cart </a>
						</div>
					</div>
			</div>
		</div>
						...
						<div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									...
									<a href="#" class="item_add single-item hvr-outline-out button2" class="use1" data-toggle="modal" data-target="#myModal4">Add to cart</a>									
								</div>
							</div>
						</div>
						<div class="col-md-3 product-men">
									...
									<div class="login-right">
										...
										<input type="hidden" name="action" value="login">
											...
											<div class="single-bottom">
												...
												<label for="brand"><span></span>Admin</label>
											</div>
											<div class="sign-in">
